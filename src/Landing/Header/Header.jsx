    ...
    return (
        <div className='flex items-center justify-between px-[30px] md:px-[94px] w-full pt-6 md:pt-10 cursor-pointer'>
            ...
            <div className='flex items-center justify-center gap-4'>
                ...
                <button className='bg-[#505050] font-inter text-[14px] md:text-[17px] px-[17px] py-[4px] md:px-[20px] md:py-[6px] rounded-[28px] text-[#EBEBEB] hover:opacity-80' onClick={handleEntrance}>
                    Login / Sign in
                </button>
            </div>
        </div>
