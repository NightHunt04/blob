...
function Header() {
    ...
    return (
        <div className='flex items-center justify-between px-[30px] xl:px-[94px] w-full pt-6 xl:pt-10 cursor-pointer'>
            <h1 className='text-[24px] xl:text-[30px] font-bold font-roboto-serif'>
                <Lg gradient={['to right', '#ABDE73, #be5869']}>
                m.
                </Lg>
            </h1>
            <div className='flex items-center justify-center gap-4'>
                <div className={`flex items-center justify-center w-[30px] h-[30px] xl:w-[40px] xl:h-[40px] ${lightTheme ? 'bg-slate-900 text-gray-300' : 'bg-gray-400 text-gray-900'} rounded-full border-gray-500 border-2`} onClick={toggleLightTheme}>
                ...
                <div className='relative group'>
                    ...
                    <button className='relative bg-[#323232] group-hover:bg-[#282828] transition duration-300 font-inter text-[14px] xl:text-[17px] px-[8px] py-[4px] xl:px-[11px] xl:py-[6px] rounded-[28px] text-[#dedede]' onClick={handleEntrance}>
                        {
                            localStorage.getItem('currentUserDisplayName') !== null ?
                                <div><span className='text-[14px] px-1 xl:text-[16px] font-inter group-hover:text-white transition duration-200'>Go to action</span></div>
                            :
