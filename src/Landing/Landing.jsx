  ...
  return (
    <div className={`${lightTheme ? 'bg-[#e8e8e8]' : 'bg-[#151515]'} w-full min-h-screen flex flex-col items-center justify-start select-none pb-7`}>
      ...
      <div className='relative flex flex-col items-center justify-center py-[100px]'>
        <p className={`font-inter text-[25px] md:text-[32px] font-bold z-20 ${lightTheme ? 'text-black' : 'text-[#c4c4c4]'} pt-12`}>Chat with the model</p>
        <p className={`font-inter text-[15px] md:text-[20px] font-regular z-20 ${lightTheme ? 'text-black' : 'text-[#c4c4c4]'} max-w-full px-6 md:max-w-[580px] text-center pb-12`}>Embrace Curiosity, Empower Learning: Journey into the Depths of Knowledge with AI, Where Every Question Unveils a New Realm of Insight and Understanding</p>
        <div className='absolute transform translate-x-[40px] translate-y-[50px] md:translate-x-[235px] md:translate-y-[140px] w-[440px] h-[440px] md:w-[800px] md:h-[800px] opacity-50 z-10'>
        ...
        <div className='absolute transform translate-x-[170px] translate-y-[40px] md:translate-x-[175px] md:translate-y-[90px] w-[300px] h-[300px] md:w-[300px] md:h-[900px] opacity-50'>
      ...
      <div className='relative flex flex-col items-center justify-center py-[100px]'>
        <p className={`font-inter text-[25px] md:text-[29px] z-20 font-bold ${lightTheme ? 'text-black' : 'text-[#c4c4c4]'} pt-12`}>Generate images</p>
        <p className={`font-inter text-[15px] md:text-[18px] z-20 font-regular ${lightTheme ? 'text-black' : 'text-[#c4c4c4]'} max-w-full px-6 md:max-w-[580px] text-center pb-12`}>Unleash Your Imagination, Transforming Ideas into Captivating Visuals: Harness the Power of AI to Craft Beautiful Images from Your Thoughts and Words</p>

         <div className='absolute transform translate-x-[70px] translate-y-[70px] md:translate-x-[235px] md:translate-y-[140px] w-[440px] h-[440px] md:w-[900px] md:h-[800px] opacity-50 z-10'>
           <svg id="sw-js-blob-svg" className="blur-md magicpattern3" viewBox="10 5 150 150">  
             <defs>                        
               <linearGradient id="sw-gradient" x1="0" x2="1" y1="1" y2="0">          
                 <stop id="stop1" stop-color="rgba(168.212, 55, 248, 1)" offset="0%"></stop>
      ...
      <div className='relative flex flex-col items-center justify-center py-[100px]'>
        <p className={`font-inter text-[25px] md:text-[29px] z-20 font-bold ${lightTheme ? 'text-black' : 'text-[#c4c4c4]'} pt-12`}>Tune your own model</p>
        <p className={`font-inter text-[15px] md:text-[18px] z-20 font-regular ${lightTheme ? 'text-black' : 'text-[#c4c4c4]'} max-w-full px-6 md:max-w-[580px] text-center pb-12`}>Unlocking AI Authenticity: Molding Distinctive Personalities through the Creative Influence of Words and Prompts, Where Every Expression Shapes a Unique Identity</p>

        <div className='absolute transform translate-x-[40px] translate-y-[20px] md:translate-x-[175px] md:translate-y-[0px] w-[500px] h-[500px] md:w-[900px] md:h-[900px] opacity-50'>
          <svg id="sw-js-blob-svg" className="blur-md magicpattern2" viewBox="10 -170 400 400">  
             <defs>                        
               <linearGradient id="sw-gradient" x1="0" x2="1" y1="1" y2="0">          
                 <stop id="stop1" stop-color="rgba(168.212, 55, 248, 1)" offset="0%"></stop>
