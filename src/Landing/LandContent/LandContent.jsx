    ...
    return (
        <div>
            ...
            <div className='relative flex flex-col items-center justify-center py-[100px] overflow-hidden'>
                ...
                <p className={`font-inter text-[14px] sm:text-[14px] md:text-[19px] font-regular z-20 ${lightTheme ? 'text-black' : 'text-[#e6e6e6]'} max-w-full px-6 md:max-w-[580px] text-center pb-12`}>Embrace Curiosity, Empower Learning: Journey into the Depths of Knowledge with AI, Where Every Question Unveils a New Realm of Insight and Understanding</p>
            ...
            <div className='relative flex flex-col items-center justify-center py-[100px] overflow-hidden'>
                ...
                <p className={`font-inter text-[14px] sm:text-[14px] md:text-[19px] z-20 font-regular ${lightTheme ? 'text-black' : 'text-[#e6e6e6]'} max-w-full px-6 md:max-w-[580px] text-center pb-12`}>Unleash Your Imagination, Transforming Ideas into Captivating Visuals: Harness the Power of AI to Craft Beautiful Images from Your Thoughts and Words</p>
            ...
            <div className='relative flex flex-col items-center justify-center py-[100px] overflow-hidden'>
                ...
                <p className={`font-inter text-[14px] sm:text-[14px] md:text-[19px] z-20 font-regular ${lightTheme ? 'text-black' : 'text-[#e6e6e6]'} max-w-full px-6 md:max-w-[580px] text-center pb-12`}>Unlocking AI Authenticity: Molding Distinctive Personalities through the Creative Influence of Words and Prompts, Where Every Expression Shapes a Unique Identity</p>
