  ...
  return (
    ...
    <div className='bg-black w-full min-h-screen flex flex-col items-center justify-start select-none'>
      ...
      <h1 className='text-[70px] md:text-[150px] font-bold font-roboto-serif'>
        ...
        <span className='text-[70px] md:text-[150px] text-[#555555] font-bold font-roboto-serif'>Mate</span>
      </h1>
      ...
      <div className='w-full md:w-[1200px] md:h-[700px] rounded-xl py-4 px-3'>
        <img src="/public/Assets/talk-up.JPG" alt="img" className='w-full h-full object-cover rounded-xl'/>
      </div>
      ...
      <div className='w-full md:w-[1200px] md:h-[700px] rounded-xl py-4 px-3'>
        <img src="/public/Assets/bob.JPG" alt="img" className='w-full h-full object-cover rounded-xl'/>
      </div>
      ...
      <div className='w-full md:w-[1200px] md:h-[700px] rounded-xl py-4 px-3'>
        <img src="/public/Assets/tune.JPG" alt="img" className='w-full h-full object-cover rounded-xl'/>
      </div>
