...
function About() {
    ...
    return (
        <div className={`${lightTheme ? 'bg-[#e8e8e8] text-black' : 'bg-[#151515] text-gray-200'} relative w-full min-h-screen flex flex-col items-center font-inter justify-start overflow-hidden pb-6`}>
            ...
            <div className={'flex flex-col w-[90%] xl:w-9/12 items-center pt-[80px] lg:pt-[100px] justify-center'}>
                <div className={`w-[97%] rounded-xl lg:text-[16px] flex flex-col items-center justify-center ${lightTheme ? 'bg-[#efefef] shadow-lg' : 'bg-[#2c2c2c]'} p-4`}>
