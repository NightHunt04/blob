    ...
    return (
        <div className={`${lightTheme ? 'bg-[#e8e8e8] text-black' : 'bg-[#151515] text-gray-200'} relative w-full min-h-screen flex flex-col items-center font-inter justify-start overflow-hidden pb-6`}>
            ...
            <div className={'flex flex-col w-[90%] md:w-9/12 items-center pt-[80px] lg:pt-[100px] justify-center'}>
                <div className="w-[97%] rounded-xl lg:text-[16px] flex flex-col items-center justify-center bg-[#0e0e0e] p-4">
                ...
                <div className="w-[97%] rounded-xl text-[15px] lg:text-[17px] flex flex-col items-center justify-center bg-[#0e0e0e] p-4 mt-2 lg:mt-5">
                    <div className="w-full text-left pt-3 px-4">
                ...
                <div className="w-[97%] rounded-xl text-[15px] lg:text-[17px] flex flex-col items-center justify-center bg-[#0e0e0e] p-4 mt-[50px] lg:mt-[100px]">
