...
function ChatModel() {
    ...
    return (
        <div className={`${lightTheme ? 'bg-[#e8e8e8] text-black' : 'bg-[#151515] text-gray-200'} relative w-full min-h-screen flex flex-col items-center justify-start select-none pb-7 overflow-hidden`}>
            <div className={`block font-inter mt-[50px] md:mt-[150px] border-[1px] ${lightTheme ? 'bg-[#ffffff] border-gray-300' : 'bg-[#272727] border-gray-700'} shadow-xl flex flex-col items-center justify-center px-5 py-4 mb-[190px] md:px-8 md:py-7 w-9/12 overflow-y-auto md:w-[700px] rounded-lg`}>
            ...
            <div className="fixed bottom-5 border-[1px] border-gray-500 rounded-lg flex items-center justify-center gap-3 px-2 py-2 shadow-lg bg-[#1b1b1b]">
                <input type="text" className="w-9/12 md:w-[700px] px-3 md:px-4 py-1 text-[15px] md:text-[18px] font-inter bg-transparent outline-none" placeholder="Your prompt here"/>
