...
function Settings() {
    ...
    return (
        <div className={`setting ${settings ? 'w-[300px] lg:w-[400px]' : 'w-0'} ${lightTheme ? 'text-[#343434] bg-[#cecece]' : 'text-[#e6e6e6] bg-[#363636]'} font-inter text-[15px] lg:text-[18px] overflow-hidden absolute transition-all shadow-2xl h-screen right-0 top-0 z-20 rounded-bl-xl`}>
