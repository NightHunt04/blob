...
function MainActionLanding() {
    ...
    return (
        <div className="w-full flex flex-col items-start justify-center px-[20px] xl:px-[100px] pt-5">

            <div className={`mb-[75px] xl:mb-[120px] border-[1px] border-[#c51111] rounded-xl px-3 py-2 w-full xl:w-9/12 opacity-80 ${lightTheme ? 'bg-[#cbcbcb] text-black' : 'bg-[#000000] text-gray-300'}`}>
                <span className='text-red-500 text-[13px] xl:text-[17px]'>Note:&nbsp;</span>
                <span className='text-[12px] xl:text-[16px]'>The APIs which are being used for fetching the responses from the below models are reverse engineered by someone else and are provided for absolutely free. So, in case if any model is not providing the expected response, then there are may occur internal server error which isn't in my hands, and for that I apologise.</span>
            </div>

            <p className='text-[13px] xl:text-[16px] font-inter text-gray-400 text-center w-full'>Click on the model you want to try.</p>
            ...
            <div className={`pt-6 xl:pt-[50px] py-2 w-full ${lightTheme ? 'text-gray-900' : 'text-gray-300'}`}>
                <div className='grid grid-cols-1 xl:grid-cols-2 items-start justify-center'>
                    ...
                    <div className='row-span-5'>
                        <p className='font-inter text-[15px] xl:text-[20px] font-medium ml-3 py-2'>Chat Completion Models</p>
                        <div className={`px-3 py-5 rounded-[17px] ${lightTheme ? 'bg-[#efefef]' : 'bg-[#2c2c2c]'} flex flex-col items-center justify-center shadow-xl w-full xl:w-3/4 mb-8 border-2 ${lightTheme ? 'border-[#cecece]' : 'border-none'}`}>                            
                            ...
                            <div className='grid grid-cols-4 items-start gap-y-[26px] xl:gap-y-[33px] justify-center gap-2 w-full xl:w-calc(w-3/4 - 20px) border-b-[1px] pb-4 mb-10 border-gray-600'>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('mistral-7b')}>
                                    ...
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Mistral OpenOcra</p>
                                </div>
                            </div>
                            ...
                            <div className='grid grid-cols-4 items-start gap-y-[26px] xl:gap-y-[33px] justify-center gap-2 w-full xl:w-calc(w-3/4 - 20px) border-b-[1px] pb-4 mb-10 border-gray-600'>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('llama')}>
                                    ...
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>CodeLLama-7b</p>
                                </div>
                            </div>
                            ...
                            <div className='grid grid-cols-4 items-start gap-y-[26px] xl:gap-y-[33px] justify-center gap-2 w-full xl:w-calc(w-3/4 - 20px) border-b-[1px] pb-4 mb-10 border-gray-600'>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('gemma')}>
                                    ...
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Qwen-1.8B</p>
                                </div>
                            </div>

                            {/* Other models */}
                            <p className={`font-inter font-medium mb-6 text-[14px] xl:text-[17px] px-5 py-2 rounded-[20px] ${lightTheme ? 'bg-[#dbdbdb]' : 'bg-[#1e1e1e]'} text-center xl:text-left w-[90%]`}>Other Models</p>
                            <div className='grid grid-cols-4 items-start gap-y-[26px] xl:gap-y-[33px] justify-center gap-2 w-full xl:w-calc(w-3/4 - 20px)'>                                

                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('llama')}>
                                    <div className='w-[40px] h-[40px] xl:w-[60px] xl:h-[60px] flex items-center justify-center rounded-full overflow-hidden border-[1px] border-[#737373] bg-[#1f1f1f] hover:bg-[#363636] hover:text-gray-300 transition-all'>
                                        <img src="Assets/dolphin.jpeg" alt="LLama" className='w-full h-full object-cover'/>
                                    </div>
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Dolphin</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('llama')}>
                                    ...
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Deepseek</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('llama')}>
                                    ...
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Platypus2</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('gemma')}>
                                    <div className='w-[40px] h-[40px] xl:w-[60px] xl:h-[60px] flex items-center justify-center rounded-full overflow-hidden border-[1px] border-[#737373] bg-[#1f1f1f] hover:bg-[#363636] hover:text-gray-300 transition-all'>
                                        <p className='font-inter font-semibold text-[14px] xl:text-[20px] text-white'>TM</p>
                                    </div>
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Toppy-M</p>
                                </div>
                                ...
                                {/* <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('cohere')}>
                                    ...
                                    <p className={`font-inter text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Cohere</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('phi')}>
                                    ...
                                    <p className={`font-inter text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Phi</p>
                                </div>
                    ...
                    <div className='row-span-1'>
                        <p className='font-inter text-[15px] xl:text-[20px] font-medium ml-3 py-2'>Image Generation</p>
                        <div className={`px-3 py-5 rounded-[17px] ${lightTheme ? 'bg-[#efefef]' : 'bg-[#2c2c2c]'} flex flex-col items-center justify-center shadow-xl w-full xl:w-3/4 mb-8 border-2 ${lightTheme ? 'border-[#cecece]' : 'border-none'}`}>
                            <p className={`font-inter font-medium mb-6 text-[14px] xl:text-[17px] px-5 py-2 rounded-[20px] ${lightTheme ? 'bg-[#dbdbdb]' : 'bg-[#1e1e1e]'} w-[90%] text-center xl:text-left`}>Image Generative Models</p>

                            <div className='grid grid-cols-4 items-start justify-center gap-2 w-full xl:w-calc(w-3/4 - 20px)'>
                            <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('pollinations')}>
                                    ...
                                    <p className={`font-inter text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Pollinations</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('dalle')}>
                                    ...
                                    <p className={`font-inter text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Dall-E</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('sd')}>
                                    <div className='w-[40px] h-[40px] xl:w-[60px] xl:h-[60px] flex items-center justify-center rounded-full overflow-hidden border-[1px] border-[#737373] bg-[#ce9000] hover:bg-[#ce9000e4] hover:text-gray-300 transition-all'>
                                        <p className='font-inter font-semibold text-[14px] xl:text-[20px] text-white'>SD</p>
                                    </div>
                                    <p className={`font-inter text-[13px] pt-1 xl:text-[16px] e-full text-center ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Stable Diffusion</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('sdxl')}>
                                    <div className='w-[40px] h-[40px] xl:w-[60px] xl:h-[60px] flex items-center justify-center rounded-full overflow-hidden border-[1px] border-[#737373] bg-[#ce4f00] hover:bg-[#ce4f00e3] hover:text-gray-300 transition-all'>
                                        <p className='font-inter font-semibold text-[14px] text-white xl:text-[20px]'>SDXL</p>
                                    </div>
                                    <p className={`font-inter text-[13px] pt-1 xl:text-[16px] e-full text-center ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Stable Diffusion XL</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('sdxl')}>
                                    ...
                                    <p className={`font-inter text-[13px] pt-1 xl:text-[16px] e-full text-center ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Open Journey</p>
                                </div>

                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer hover:opacity-80 my-2' onClick={() => navigate('sdxl')}>
                                    <div className='w-[40px] h-[40px] xl:w-[60px] xl:h-[60px] flex items-center justify-center rounded-full overflow-hidden border-[1px] border-[#737373] bg-[#ce4f00] hover:bg-[#ce4f00e3] hover:text-gray-300 transition-all'>
                                        <p className='font-inter font-semibold text-[14px] text-white xl:text-[20px]'>AS</p>
                                    </div>
                                    <p className={`font-inter text-[13px] pt-1 xl:text-[16px] e-full text-center ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Analog Diffusion</p>
                                </div>
                            </div>
                        </div>    
                    </div>
                    ...
                    {/* models for fun */}
                    <div className='row-span-1'>
                        <p className='font-inter text-[15px] xl:text-[20px] font-medium ml-3 py-2'>Assistants</p>
                        <div className={`px-3 py-5 rounded-[17px] ${lightTheme ? 'bg-[#efefef]' : 'bg-[#2c2c2c]'} flex flex-col items-center justify-center shadow-xl w-full xl:w-3/4 mb-8 border-2 ${lightTheme ? 'border-[#cecece]' : 'border-none'}`}>
                            <p className={`font-inter font-medium mb-6 text-[14px] xl:text-[17px] px-5 py-2 rounded-[20px] ${lightTheme ? 'bg-[#dbdbdb]' : 'bg-[#1e1e1e]'} w-[90%] text-center xl:text-left`}>Fine-tunned assistants</p>
                            ...
                            <div className='grid grid-cols-4 items-start justify-center gap-2 w-full xl:w-calc(w-3/4 - 20px)'>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer my-2' onClick={() => navigate('human')}>
                                    ...
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Human</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer my-2' onClick={() => navigate('mario')}>
                                    ...
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Super Mario</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer my-2' onClick={() => navigate('strange')}>
                                    ...
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Dr. Strange</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer my-2' onClick={() => navigate('walter')}>
                                    ...
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Walter White</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='row-span-1'>
                        <p className='font-inter text-[15px] xl:text-[20px] font-medium ml-3 py-2'>Reverse Engineerd GPTs (3rd Party)</p>
                        <div className={`px-3 py-5 rounded-[17px] ${lightTheme ? 'bg-[#efefef]' : 'bg-[#2c2c2c]'} flex flex-col items-center justify-center shadow-xl w-full xl:w-3/4 mb-8 border-2 ${lightTheme ? 'border-[#cecece]' : 'border-none'} font-inter`}>
                            <p className={`font-medium mb-6 text-[14px] xl:text-[17px] px-5 py-2 rounded-[20px] ${lightTheme ? 'bg-[#dbdbdb]' : 'bg-[#1e1e1e]'} w-[90%] text-center xl:text-left`}><span className='text-[#7eb9a9]'>GPT</span> models</p>
                            
                            <p className='text-[13px] xl:text-[16px] p-2 pb-5'><span className='font-bold'>Note:&nbsp;</span>These models may act unusual sometimes</p>
                            ...
                            <div className='grid grid-cols-4 items-start justify-center gap-2 w-full xl:w-calc(w-3/4 - 20px)'>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer my-2' onClick={() => navigate('chatgpt-3')}>
                                    ...
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Gpt-3</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer my-2' onClick={() => navigate('chatgpt-curie')}>
                                    ...
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Curie</p>
                                </div>
                                ...
                                <div className='flex flex-col items-center justify-center gap-1 hover:cursor-pointer my-2' onClick={() => navigate('chatgpt-davinci')}>
                                    ...
                                    <p className={`font-inter text-center text-[13px] pt-1 xl:text-[16px] ${lightTheme ? 'text-black' : 'text-gray-300'}`}>Davinci</p>
                                </div>
                    ...
                    <div className='row-span-1'>
                        <p className='font-inter text-[15px] xl:text-[20px] font-medium ml-3 py-2'>Check out the bot on <span className='text-[#24A1DE]'>telegram!</span></p>
                        <div className={`px-3 py-5 rounded-[17px] ${lightTheme ? 'bg-[#efefef]' : 'bg-[#2c2c2c]'} flex items-center justify-center shadow-xl w-full xl:w-3/4 mb-8 border-2 ${lightTheme ? 'border-[#cecece]' : 'border-none'} font-inter`}>
                            <img src="Assets/pngwing.png" alt="telegram" className='animate-tele w-[100px] relative xl:w-[180px] object-cover'/>
                            <div className='flex flex-col items-center justify-center gap-3'>
                                <p className='font-inter text-[13px] xl:text-[17px]'><span className='text-[#24A1DE]'>@modelmatebot</span> on telegram</p>
                                <Link className={`rounded-2xl text-[15px] xl:text-[17px] ${lightTheme ? 'bg-[#d6d6d6]' : 'bg-[#1e1e1e]'} px-4 py-2 hover:opacity-80`} to='https://t.me/modelmatebot' target='__blank'>Redirect to telegram bot? Click me</Link>
                            </div>
                        </div>
                    </div>
                </div>
