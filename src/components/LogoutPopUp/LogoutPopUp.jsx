...
function LogoutPopUp() {
    ...
    return (
        <div className={`${logoutPopUp ? 'translate-y-[40px] md:translate-y-[180px]' : '-translate-y-[1000px]'} transition-all text-[15px] md:text-[17px] font-inter z-40 w-[300px] md:w-[730px] ${lightTheme ? 'bg-gray-100 text-gray-900' : 'bg-[#292929] text-gray-300'} shadow-2xl  mx-auto top-[300px] rounded-xl fixed`}>
            <div className="w-full h-full flex flex-col items-center justify-start">
                ...
                <div className="flex items-center justify-center gap-3 py-6">
                    ...
                    <button className="px-4 md:px-10 py-1 bg-[#1c1c1c] text-gray-300 rounded-[28px] hover:opacity-90" onClick={handleLogOut}>I'm sure</button>
                </div>
            </div>
        </div>
    )
