...
function LogoutPopUp() {
    ...
    return (
        <div className={`${logoutPopUp ? 'translate-y-[80px] md:translate-y-[180px]' : '-translate-y-[1000px]'} transition-all text-[15px] md:text-[17px] font-inter z-40 w-[300px] md:w-[730px] ${lightTheme ? 'bg-gray-100 text-gray-900' : 'bg-[#292929] text-gray-300'} shadow-2xl  mx-auto top-[300px] rounded-xl fixed`}>
